...
<style type="text/css">
body {
	background-image: url("images/partner_home_page.jpg");
	background-size: 100%;
				...
				<div class="modal-body">
					...
					<c:if test="${user.order.orderId != 0}">
						...
						<p>
							...
							:
							<c:out value="${user.order.bar.seats}" />
						<p>
							<fmt:message key="label.description" />
							:
							<c:out value="${user.order.bar.description}" />
						<p>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<p>
					<form name="bar" method="POST" action="controller">
						<button name="command" value="delete_rent" type="submit"
							class="btn btn-danger btn-block center-block">
							<fmt:message key="label.delete" />
						</button>
					</form>
